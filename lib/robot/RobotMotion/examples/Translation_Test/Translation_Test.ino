...
void translation(double distance)
{
  ...
  //currentPosition = (wheelControledRight.getPosition() + wheelControledLeft.getPosition()) / 2.0 ; // TYPE 1 : Used with a reset
  currentPosition = wheelControledRight.getPosition() ; // TYPE 2 : use this one when no reset is possible
  ...
  demandedPosition = currentPosition;
...
void turn(double demandedAngle)
{
  ...
  //currentPosition = (wheelControledRight.getPosition() - wheelControledLeft.getPosition()) / 2.0 ; // TYPE 1 : need Reset of encoder
  currentPosition = wheelControledRight.getPosition() ; // TYPE 2 : no need for reset of encoder
